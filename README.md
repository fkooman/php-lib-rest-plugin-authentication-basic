[![Build Status](https://travis-ci.org/fkooman/php-lib-rest-plugin-authentication-basic.svg?branch=master)](https://travis-ci.org/fkooman/php-lib-rest-plugin-authentication-basic)
